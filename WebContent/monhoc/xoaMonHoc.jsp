	...
	<body>
		...
		<div class="content-header">
			...
			<ol class="breadcrumb">
				...
				<li class="active">Xoá môn học</li>
			</ol>
		</div>
				...
				<div class="box-body">
					...
					<div class="row">
						<div class="col-md-6 col-md-offset-2">
							<form action="xoamonhoc" method="post" class="form-horizontal">
								<div class="box-body">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" class="form-control" readonly="readonly" name="tenMH" value="<%= mh.getTenMH() %>">
										</div>
									</div>
								</div>
								<!-- /.box-body -->
								<div class="box-footer">
									<div class="pull-right">
										<button type="submit" class="btn btn-danger btn-flat" name="submit" value="submit">Xóa</button>
