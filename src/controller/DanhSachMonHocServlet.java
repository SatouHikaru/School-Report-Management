...
/**
 * Servlet implementation class DanhSachMonHocAdminServlet
 */
public class DanhSachMonHocServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DanhSachMonHocServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			RequestDispatcher rd = request.getRequestDispatcher("/monhoc/danhSach.jsp");
			rd.forward(request, response);
		} catch (SQLException e) {
			e.printStackTrace();
		}
