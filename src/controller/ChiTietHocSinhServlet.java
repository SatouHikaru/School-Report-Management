...
public class ChiTietHocSinhServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (session.getAttribute("phuHuynh") != null && session.getAttribute("phuHuynh").equals("Phụ huynh")) {
			try {
		...
		RequestDispatcher rd = request.getRequestDispatcher("hocsinh/chiTiet.jsp");
		rd.forward(request, response);
	}
