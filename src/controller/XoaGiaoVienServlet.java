...
/**
 * Servlet implementation class XoaGiaoVienServlet
 */
public class XoaGiaoVienServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public XoaGiaoVienServlet() {
		super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			GiaoVienBO.getInstance().remove(Long.valueOf(maGV));
