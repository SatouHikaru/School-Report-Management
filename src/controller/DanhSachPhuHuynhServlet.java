...
/**
 * Servlet implementation class DanhSachPhuHuynhAdminServlet
 */
public class DanhSachPhuHuynhServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DanhSachPhuHuynhServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			ArrayList<PhuHuynh> ph = PhuHuynhBO.getInstance().getAll(term, maLop);
			...
			RequestDispatcher rd = request.getRequestDispatcher("/phuhuynh/danhSach.jsp");
			rd.forward(request, response);
		} catch (SQLException e) {
			e.printStackTrace();
		}
