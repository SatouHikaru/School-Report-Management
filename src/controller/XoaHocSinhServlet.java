...
/**
 * Servlet implementation class XoaHocSinhServlet
 */
public class XoaHocSinhServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public XoaHocSinhServlet() {
        super();
...
//		long maPH = Long.valueOf(request.getParameter("maph"));
		try {
			HocSinhBO.getInstance().remove(maHS);
//			PhuHuynhBO.getInstance().remove(maPH);
		} catch (SQLException e) {
			e.printStackTrace();
		}
	}
